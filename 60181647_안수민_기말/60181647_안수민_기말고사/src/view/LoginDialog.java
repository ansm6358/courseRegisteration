...
public class LoginDialog extends JDialog {
	...
	private class MouseHandler implements MouseListener{	
		...
		public void mouseEntered(MouseEvent arg0) {
			...
			Date today = new Date();	        
		    SimpleDateFormat date = new SimpleDateFormat(ETime.datainfo.getString());
		    SimpleDateFormat time = new SimpleDateFormat(ETime.timeinfo.getString());	        	    
			clock.setToolTipText(ETime.date.getString()+date.format(today)+ETime.gap.getString()+ETime.time.getString()+time.format(today));
		}
		@Override

...
public class Constants {
	...
	public static enum ECredit{
		...
		private String value;
		private ECredit(String value) {this.value = value;}
		public String getString() {return this.value;}
		public int getInt() {return Integer.parseInt(this.value);}
	}
	public static enum EOverlapTime{
		gap(" "),
		MaxCredit("20"),
		jump("\r\n"),
		message("강의시간이 중복되었습니다."),
		message2("해당강좌(basket): "),
		message3("강의시간: "),
		message4("중복된 강의: ");
		
		
		private String value;
		private EOverlapTime(String value) {this.value = value;}
		public String getString() {return this.value;}
		public int getInt() {return Integer.parseInt(this.value);}
	}
	...
	public static enum ETime{
		...
		private String value;
		private ETime(String value) {this.value = value;}
		public String getString() {return this.value;}
		public int getInt() {return Integer.parseInt(this.value);}
	}
	public static enum EFinal{
		serialVersionUID("1"),
		title("last"),
		message("최종학점: ");
		
		private String value;
		private EFinal(String value) {this.value = value;}
		public String getString() {return this.value;}
		public int getInt() {return Integer.parseInt(this.value);}
	}
}

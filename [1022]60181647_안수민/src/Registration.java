...
public class Registration extends JPanel {
	...
	public Registration(MainFrame mainFrame) {
		...
		upPanel.setPreferredSize(new Dimension(0, Constants.MAIN_H/10));
		upPanel.setLayout(new BorderLayout(10, 5));
		...
		BSpanel.setBackground(Color.GREEN);
		panel3.add(BSpanel);
		...
		Spanel2.setBackground(Color.CYAN);
		...
		panel4.setPreferredSize(new Dimension(0, Constants.MAIN_H*3/20));
		...
		Apanel1.setPreferredSize(new Dimension(Constants.MAIN_W*7/40, 0));

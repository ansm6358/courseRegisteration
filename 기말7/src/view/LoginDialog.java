...
public class LoginDialog extends JDialog {
	...
	public LoginDialog(ActionListener actionHandler) {
		...
		ImageIcon ImageLogin = new ImageIcon("image/1.png");
		Image loginImageChange = ImageLogin.getImage();
		Image changeLoginImage = loginImageChange.getScaledInstance(40, 20, Image.SCALE_SMOOTH);
		ImageIcon loginImage = new ImageIcon(changeLoginImage);
		
		ImageIcon ImageCancle = new ImageIcon("image/2.png");
		Image CancleImageChange = ImageCancle.getImage();
		Image changeCancleImage = CancleImageChange.getScaledInstance(40, 20, Image.SCALE_SMOOTH);
		ImageIcon cancleImage = new ImageIcon(changeCancleImage);
		...
		cancleButton= new JButton(cancleImage);

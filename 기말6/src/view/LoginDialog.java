...
public class LoginDialog extends JDialog {
	...
	public LoginDialog(ActionListener actionHandler) {
		...
		//ImageIcon loginIcon = new ImageIcon("12.png");
		//ImageIcon loginIcon2 = new ImageIcon("20.png");
		...
		ImageIcon okoriginalIcon = new ImageIcon("12.png");
		Image okoriginalImage = okoriginalIcon.getImage();
		Image okChangedImage = okoriginalImage.getScaledInstance(35, 20, Image.SCALE_SMOOTH);
		ImageIcon okchangedIcon = new ImageIcon(okChangedImage);
		//okButton.setBackground(Color.GREEN);
		okButton.setIcon(okchangedIcon);
		...
		ImageIcon canceloriginalIcon = new ImageIcon("21.png");
		Image canceloriginalImage = canceloriginalIcon.getImage();
		Image cancelChangedImage = canceloriginalImage.getScaledInstance(35, 20, Image.SCALE_SMOOTH);
		ImageIcon cancelchangedIcon = new ImageIcon(cancelChangedImage);
		//cancleButton.setBorderPainted(false);
		//okButton.setFocusPainted(false);
		//okButton.setContentAreaFilled(false);
		cancleButton.setIcon(cancelchangedIcon);
